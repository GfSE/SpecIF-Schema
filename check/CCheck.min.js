...
"resourceClass")});u(e.resourceClasses,e.resourceClasses,"extends","resourceClass")})();(function(){var c=e.resourceClasses.concat(e.statementClasses);e.statementClasses.forEach(function(f){r(f);["subjectClasses","objectClasses"].forEach(function(a){var b;if(b=k.doCheck.includes("class."+a))a:{b=f[a];if(Array.isArray(b)){if(1>b.length){b=!0;break a}for(var d=b.length-1;-1<d;d--)if(q(c,b[d])){b=!0;break a}}b=!1}b&&g.push({status:978,statusText:a+" of class '"+f.id+"' must reference at least one valid resourceClass or statementClass"})})});
